...
def forward(x, y):
    for i in range(x, y):
        turtle.forward(120)
        turtle.write("%d" %(i), font=("Arial", 10, "normal"))
"""
************************************************************
...
def nums():
    ...
    forward(2,6)
    turtle.goto(-290, -80)
    turtle.write("10", font=("Arial", 10, "normal"))
    backward(9, 5)
    turtle.goto(-290, 40)
    turtle.write("11", font=("Arial", 10, "normal"))
    forward(12, 16)
    turtle.goto(-290, 160)
    turtle.write("20", font=("Arial", 10, "normal"))
    backward(19,15)
    turtle.goto(-290, 280)
    turtle.write("21", font=("Arial", 10, "normal"))
    forward(22, 26)
    turtle.hideturtle()
